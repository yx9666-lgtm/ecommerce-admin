  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "glow-gold": "0 4px 20px rgba(255, 193, 7, 0.15), 0 0 0 1px rgba(255, 193, 7, 0.1)",
        "glow-gold-lg": "0 8px 32px rgba(255, 193, 7, 0.2), 0 0 0 1px rgba(255, 193, 7, 0.15)",
        "btn-gold": "0 2px 12px rgba(255, 179, 0, 0.25), 0 1px 3px rgba(0, 0, 0, 0.06)",
        "btn-gold-hover": "0 4px 20px rgba(255, 179, 0, 0.35), 0 2px 6px rgba(0, 0, 0, 0.08)",
        "sidebar-active": "0 2px 12px rgba(255, 193, 7, 0.2)",
      },
      fontFamily: {
